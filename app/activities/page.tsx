...
import Latest from "@/components/LatestActivity/Latest";
import ActivitiesData from "./ActivitiesData";

export default function Activities() {
  return (
    <div className="mx-5 md:mx-10 text-black dark:text-[#f4f5f6]">
      <div className="my-16">
        <Latest />
      </div>
      <div>
            ...
            <div className="flex mt-4 justify-between">
              ...
              <div className="flex gap-x-6">
                <div className="dropdown dropdown-bottom">
                  ...
                  <ul
                    tabIndex={0}
                    className="dropdown-content menu p-2 shadow bg-base-100 dark:bg-[#44403c] rounded-box w-36"
                  >
                    <li>
                      <a>Item 1</a>
                    </li>
                ...
                <div className="dropdown dropdown-bottom">
                  ...
                  <ul
                    tabIndex={0}
                    className="dropdown-content menu p-2 shadow bg-base-100 dark:bg-[#44403c] rounded-box w-[9rem]"
                  >
                    <li>
                      <a>Item 1</a>
                    </li>
