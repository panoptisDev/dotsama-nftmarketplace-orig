...
export default function Latest() {
  return (
    <div className="flex justify-center">
      <div className="bg-white dark:bg-[#232323] px-4 lg:px-16 py-3 md:py-6 rounded-3xl banner-shadow w-full md:w-3/4 2xl:w-1/2">
        <div className="flex justify-between items-center gap-x-4">
          <button className="text-xs md:text-xl px-2 py-1 bg-[#24B692] rounded-lg text-black dark:text-[#232323] font-bold">
            SALE
          </button>
          <div className="flex flex-row items-center gap-x-2 lg:gap-x-8">
